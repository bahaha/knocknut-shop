...
(
  ...
  DEFAULT CHARSET = utf8
  COLLATE = utf8_bin COMMENT ='增加服務應用ID';
...
(
    ...
    `max_size`          int(10) unsigned    NOT NULL DEFAULT '0' COMMENT '單個配置大小上限，單位為bytes，0表示使用預設值',
    `max_aggr_count`    int(10) unsigned    NOT NULL DEFAULT '0' COMMENT '聚合子配置最大個數，，0表示使用預設值',
    `max_aggr_size`     int(10) unsigned    NOT NULL DEFAULT '0' COMMENT '單個聚合數據的子配置大小上限，單位為bytes，0表示使用預設值',
...
(
  ...
  DEFAULT CHARSET = utf8
  COLLATE = utf8_bin COMMENT ='多服務應用改造';
...
(
    ...
    `gmt_create`    bigint(20)   NOT NULL COMMENT '新增時間',
